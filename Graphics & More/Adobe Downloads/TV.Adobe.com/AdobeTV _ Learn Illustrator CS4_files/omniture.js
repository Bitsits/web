...
if (!window.s_accountName) { 
	...
	else if ((s_Host.indexOf("atvdev.com") != -1) || (s_Host.indexOf("dev.tv.adobe") != -1)) {
	  var s_account="mxadobetvqa";	
	}
...
s.linkInternalFilters="javascript:,adobe,macromedia,dreamweaver,flash,shockwave,sdc,markme,sdc.shockwave,infopoll,developerlocator.macromedia,adobemax2007.com,photoshop.com,acrobat.com,atvdev.com,../";
s.linkLeaveQueryString=false;
s.linkTrackVars="None";
s.linkTrackEvents="None";
s.server="Adobe TV 3.0";
