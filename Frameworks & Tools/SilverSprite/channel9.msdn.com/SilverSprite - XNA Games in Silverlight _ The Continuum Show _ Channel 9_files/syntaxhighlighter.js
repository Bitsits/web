		...
		toolbar: {
			...
			*/
			handler: function (e) {
				...
				// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
				//'attachEvent' has been modified to prevent memory leaks
	...
	function attachEvent(obj, type, func, scope) {
		function handler(e) {
			...
			if (!e.target) {
				...
				/*
				!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
				This section will leak memory in ie
				'Event handler for a toolbar anchor' has been modified
	...
	sh.Highlighter.prototype = {
		...
		*/
		getDiv: function (code) {
			...
			div = $(div).addClass('syntaxhighlighterHolder').get(0);
			return div;
		},
