...
function MS_StatsDotNet()
{
    ...
    this.LogPageOnUnLoad = function() {
        ...
        if (this.eventSeqNo == '0') this.eventSeqNo = this.GetCookieIncrement();
...
function SMCollapseExpand(obj) {
    ...
    } else if ($(smobj).css("display").toLowerCase() == "inline-block") {
...
function SocialMediaClickHandle(event) {
    ...
    var gss_socialmedia = ElementsByName('div', 'gss_socialmedia');
