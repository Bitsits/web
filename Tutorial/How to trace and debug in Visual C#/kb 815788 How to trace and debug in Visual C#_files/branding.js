...
var gsfx_brnd_dontshowad = function()
{
    var d = new Date();
    var cs = 'mcUA=' + d.toUTCString() + ';expires=' + d.toGMTString(d.setFullYear(d.getFullYear() + 1)) + '; Domain=microsoft.com;path=/';
    document.cookie = cs;
};
$('#gsfx_brnd_corpflyoutad_go').click(gsfx_brnd_dontshowad);

var gsfx_brnd_flyoutad_close = function(perm)
{
    $('#gsfx_brnd_corpflyoutad').animate(
        {
            width: '0px',
            height: '0px',
            opacity: 0
        ...
        function()
        {
            $('#gsfx_brnd_corpflyoutad_inner').css('display', 'none');
            if (perm === true)
            {
...
$('#gsfx_brnd_corpflyoutad_close').click(gsfx_brnd_flyoutad_close);

var gsfx_brnd_flyoutad_close_perm = function() { gsfx_brnd_flyoutad_close(true); };
$('#gsfx_brnd_corpflyoutad_dontshow').click(gsfx_brnd_flyoutad_close_perm);

var gsfx_brnd_flyoutad_open = function(autoclose)
{
    $('#gsfx_brnd_corpflyoutad_inner').css('display', 'block');
    $('#gsfx_brnd_corpflyoutad').animate(
        {
            width: $('#gsfx_brnd_corpflyoutad_inner').css('width'),
            height: $('#gsfx_brnd_corpflyoutad_inner').css('height'),
            opacity: 1            
        },
        750,
        function()
...
$($('#gsfx_brnd_CorpMarketingSpace a').get(0)).click(gsfx_brnd_flyoutad_open);

var gsfx_brnd_adspaceload = function()
{
    if ($('#gsfx_brnd_CorpMarketingSpace').children().size() == 0) return;
    $('#gsfx_brnd_corpflyoutad').css({ opacity: 0 });
    $('#gsfx_brnd_CorpMarketingSpace a').get(0).href = 'javascript:void(0);';
...
$(document).ready(gsfx_brnd_adspaceload);