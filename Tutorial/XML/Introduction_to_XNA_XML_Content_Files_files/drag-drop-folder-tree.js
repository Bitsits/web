...
************************************************************************************************************/
    ...
    ,
    onChange : Prototype.emptyFunction  // callback added to allow for additional functionality after tree position has been modified
		,
		expandAll : function()
		{
		...
		*/
        ...
        JSTreeObj.onChange(); // execute the onChange callback
