var _msdn = [ ["default.aspx",'1175',0.14],["library",'1176',0.16],["ie",'1177',0.099],["netframework",'1178',0.14],["windowsazure",'1179',0.3],["magazine",'1180',0.14], ["office",'1181',0.3],["sharepoint",'1183',0.3],["sqlserver",'1184',0.3],["subscriptions",'1185',0.14],["vbasic",'1186',0.099], ["vcsharp",'1187',0.099],["visualc",'1188',0.099],["vstudio",'1189',0.099],["windowsphone",'1191',0.3],["windows",'1190',0.099]  ];
...
var _SC_msdn = [ ["Forums/en-US/category",'1207',0.14] ];
var _SC_technet = [ ["Forums/en-US/category",'1208',0.108],["Forums/en/itcg/threads",'1201',0.108] ]; 
...
function getIroot_resetFreq(){
	if(document.getElementsByName('Search.MSForums.Iroot')[0] && document.getElementsByName('Search.MSForums.Iroot')[0].getAttribute('content') != null){
		...
		if(_Site == '1207'){
			...
			}else if(srchMSForumIroot=="ie" || srchMSForumIroot=="vbasic" || srchMSForumIroot=="vcsharp" || srchMSForumIroot=="visualc" || srchMSForumIroot=="vstudio"){	
				_Freq=0.099;	_centerW = 100; _spyglassW=0;//	_networkW = 20;
			}else if(srchMSForumIroot=="windows"){	
				_Freq=0.16;	_centerW = 100; _spyglassW=0;//	_networkW = 20;
			}else if(/netframework/i.test(srchMSForumIroot)){	
				_Freq=0.14;	_centerW = 100; _spyglassW=0;//	_networkW = 20;
			}else{	
			...
			if(srchMSForumIroot=="windowsserver" || srchMSForumIroot=="office" || srchMSForumIroot=="systemcenter" || srchMSForumIroot=="scriptcenter" || srchMSForumIroot=="forefront" || srchMSForumIroot=="sharepoint" || srchMSForumIroot=="sqlserver" || srchMSForumIroot=="exchange"){	
				_Freq=0.108; //_centerW = 80; _networkW = 20;
			}else{	
