...
{var c=document.cookie;var mh=unescape(dapExtractValue(c,'mh',';'));var qs=(mh!='')?'&PN='+mh:'';var id=dapExtractValue(unescape(dapExtractValue(c,'ANON',';')),'A','&');var muid=unescape(dapExtractValue(c,'MUID',';'));if(id=='')
{id=muid;}
